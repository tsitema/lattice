classdef Diamond < Lattice
    ...
    properties
        ...
        eqn;
        init;
        prtrnd=0.05;%random perturbation intensity
        prt=0.05;%constant perturbation intensity
    ...
    methods
        %% CONSTRUCTOR
        function o=Diamond(n,phi,g,k,init)
       ...
       function o=buildNodes(o)
            ...
            %% *!!! SET PERIODIC VS OPEN BC HERE* 
              if xi<NX+1%NX for open NX+1 for Per
